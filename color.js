...
var Color = (function () {
    class Color {
        /**
         * Represents a color.
         * @param {*} [args] Either three/four values that resolve to numbers and represent RGBA values; an array containing them; an object that defines each of the channels of an RGBA, HSLA, HSVA, or CMYKA color; or a CSS-formatted color.
         * @return Color
         */
        constructor(...args) {
            var r = args[0];
        ...
        static resolve(string) {   
            ...
            var c = channelsFromColorFunction();
         ...
         * @param {string} [args] Either a formatted hexadecimal color, a number in hexadecimal format, or three/four hexadecimal numbers that each represent an RGBA channel.
         * @return {Color}
         */
        static hex(...args) {
            ...
            if (typeof r === "string" && args[1] === undefined) {
                ...
                args = [r.substring(0, 2), r.substring(thirdlen, thirdlen + 2), r.substring(2 * thirdlen, 2 * thirdlen + 2)];
            }
        ...
        /**
         * Creates a color based on its hue, saturation, lightness, and alpha. This is a shorthand for new Color({hue, saturation, lightness, alpha}).
        ...
        /**
         * Creates a color based on its hue, saturation, value, and alpha. This is a shorthand for new Color({hue, saturation, value, alpha}).
         * @param {number} [hue=0] The hue of the color.
        ...
        /**
         * Creates a color based on its cyan, magenta, yellow, key, and alpha values. This is a shorthand for new Color({cyan, magenta, yellow, key, alpha}).
        ...
        static fromName(name) {
            ...
            if (Color.names.hasOwnProperty(name)) return Color.names[name].clone();
        ...
        static fromInteger(integer) {
            var string = pad(valuecheck(integer, { integer: true, min: 0, max: 0xFFFFFF }).toString(16), 6);
        ...
        static random(randomAlpha) {
            var color = Color.fromInteger(Math.random() * 0xFFFFFF);
         ...
         * @param {string} [type="rgba"] The format of a color to use. ("rgb", "rgba", "hsl", "hsla", "hex" | "hexadecimal")
         * @return {Color}
         */
        toString(type) {
            switch (type) {
         ...
         * @param {string} [blendmode="normal"] The type of blend mode to use (valid CSS <blend-mode> | "add" | "subtract" | "divide" | "linear-burn").
         * @return {Color}
         */
        blend(color=new Color(), blendmode="normal") {
            if (!(color instanceof Color)) color = new Color(color);

            var priRGB = this.toArray(true);
            var secRGB = color.toArray(true);
            ...
            function channelBlend(blendingFunction) {
                ...
                return new Color(...blendedChannels, a);
            }
        }
        ...
        rgbLinear(color=new Color(), x=.5) {
            ...
            var r = getLineValue(this.r, color.r);
            var g = getLineValue(this.g, color.g);
            var b = getLineValue(this.b, color.b);
        ...
        hslLinear(color=new Color(), x=.5) {
            ...
            var h = this.rgbLinear(color, x).h;
            var s = getLineValue(this.s, color.s);
            var l = getLineValue(this.l, color.l);
        ...
        /**
         * Saturates the color.
         * @param {number|string} [points=0] The number of points by which to saturate the color or a percentage by which to multiply the saturation.
         * @return {Color} This color.
         */
        saturate(points) {
        ...
        /**
         * Lightens the color.
         * @param {number|string} [points=0] The number of points by which to lighten the color or the color or a percentage by which to multiply the lightness.
         * @return {Color} This color.
         */
        lighten(points) {
            if (isPercentage(points)) {
         ...
         * @param {number|string} [points=0] The number of points by which to opacify the color or the color or a percentage by which to multiply the opacity.
         * @return {Color} This color.
         */
        opacify(points) {
            if (isPercentage(points)) {
        ...
        get h() {
            ...
            var [r, g, b, a] = [this.r, this.g, this.b, this.a];
        ...
        set h(hue) {
            var color = Color.hsl(hue, this.s, this.l);
        ...
        get s() {
            var min = this.min() / 255;
            var max = this.max() / 255;
        ...
        set s(saturation) {
            var color = Color.hsl(this.h, saturation, this.l);
        ...
        set sHSV(saturation) {
            var color = Color.hsv(this.h, saturation, this.l);
        ...
        set l(lightness) {
            var color = Color.hsl(this.h, this.s, lightness);
        ...
        set v(value) {
            var color = Color.hsl(this.h, this.s, value);
        ...
        set c(cyan) {
            var color = Color.fromCMYK(cyan, this.m, this.y, this.k);
        ...
        set m(magenta) {
            var color = Color.fromCMYK(this.c, magenta, this.y, this.k);
        ...
        set y(yellow) {
            var color = Color.fromCMYK(this.c, this.m, yellow, this.k);
        ...
        set k(key) {
            var color = Color.fromCMYK(this.c, this.m, this.y, key);
    ...
    /**
     * @namespace Color
     * @property {object} names An object mapping each valid HTML color name to its corresponding Color object.
     * @property {number} HEXP A ratio used to convert a number out of 255 to a number out of 100.
     */
    
    Color.names = (function () {
        var colors = {aliceblue:"#f0f8ff",antiquewhite:"#faebd7",aqua:"#0ff",cyan:"#0ff",aquamarine:"#7fffd4",azure:"#f0ffff",beige:"#f5f5dc",bisque:"#ffe4c4",black:"#000",blanchedalmond:"#ffebcd",blue:"#00f",blueviolet:"#8a2be2",brown:"#a52a2a",burlywood:"#deb887",cadetblue:"#5f9ea0",chartreuse:"#7fff00",chocolate:"#d2691e",coral:"#ff7f50",cornflowerblue:"#6495ed",cornsilk:"#fff8dc",crimson:"#dc143c",darkblue:"#00008b",darkcyan:"#008b8b",darkgoldenrod:"#b8860b",darkgray:"#a9a9a9",darkgrey:"#a9a9a9",darkgreen:"#006400",darkkhaki:"#bdb76b",darkmagenta:"#8b008b",darkolivegreen:"#556b2f",darkorange:"#ff8c00",darkorchid:"#9932cc",darkred:"#8b0000",darksalmon:"#e9967a",darkseagreen:"#8fbc8f",darkslateblue:"#483d8b",darkslategray:"#2f4f4f",darkslategrey:"#2f4f4f",darkturquoise:"#00ced1",darkviolet:"#9400d3",deeppink:"#ff1493",deepskyblue:"#00bfff",dimgray:"#696969",dimgrey:"#696969",dodgerblue:"#1e90ff",firebrick:"#b22222",floralwhite:"#fffaf0",forestgreen:"#228b22",fuchsia:"#f0f",magenta:"#f0f",gainsboro:"#dcdcdc",ghostwhite:"#f8f8ff",gold:"#ffd700",goldenrod:"#daa520",gray:"#808080",grey:"#808080",green:"#008000",greenyellow:"#adff2f",honeydew:"#f0fff0",hotpink:"#ff69b4",indianred:"#cd5c5c",indigo:"#4b0082",ivory:"#fffff0",khaki:"#f0e68c",lavender:"#e6e6fa",lavenderblush:"#fff0f5",lawngreen:"#7cfc00",lemonchiffon:"#fffacd",lightblue:"#add8e6",lightcoral:"#f08080",lightcyan:"#e0ffff",lightgoldenrodyellow:"#fafad2",lightgray:"#d3d3d3",lightgrey:"#d3d3d3",lightgreen:"#90ee90",lightpink:"#ffb6c1",lightsalmon:"#ffa07a",lightseagreen:"#20b2aa",lightskyblue:"#87cefa",lightslategray:"#789",lightslategrey:"#789",lightsteelblue:"#b0c4de",lightyellow:"#ffffe0",lime:"#0f0",limegreen:"#32cd32",linen:"#faf0e6",maroon:"#800000",mediumaquamarine:"#66cdaa",mediumblue:"#0000cd",mediumorchid:"#ba55d3",mediumpurple:"#9370d8",mediumseagreen:"#3cb371",mediumslateblue:"#7b68ee",mediumspringgreen:"#00fa9a",mediumturquoise:"#48d1cc",mediumvioletred:"#c71585",midnightblue:"#191970",mintcream:"#f5fffa",mistyrose:"#ffe4e1",moccasin:"#ffe4b5",navajowhite:"#ffdead",navy:"#000080",oldlace:"#fdf5e6",olive:"#808000",olivedrab:"#6b8e23",orange:"#ffa500",orangered:"#ff4500",orchid:"#da70d6",palegoldenrod:"#eee8aa",palegreen:"#98fb98",paleturquoise:"#afeeee",palevioletred:"#d87093",papayawhip:"#ffefd5",peachpuff:"#ffdab9",peru:"#cd853f",pink:"#ffc0cb",plum:"#dda0dd",powderblue:"#b0e0e6",purple:"#800080",rebeccapurple:"#639",red:"#f00",rosybrown:"#bc8f8f",royalblue:"#4169e1",saddlebrown:"#8b4513",salmon:"#fa8072",sandybrown:"#f4a460",seagreen:"#2e8b57",seashell:"#fff5ee",sienna:"#a0522d",silver:"#c0c0c0",skyblue:"#87ceeb",slateblue:"#6a5acd",slategray:"#708090",slategrey:"#708090",snow:"#fffafa",springgreen:"#00ff7f",steelblue:"#4682b4",tan:"#d2b48c",teal:"#008080",thistle:"#d8bfd8",tomato:"#ff6347",turquoise:"#40e0d0",violet:"#ee82ee",wheat:"#f5deb3",white:"#fff",whitesmoke:"#f5f5f5",yellow:"#ff0",yellowgreen:"#9acd32"};
        return Object.freeze(objmap(colors, Color.resolve));
    })();
    ...
    function isDefined(...values) {
        for (let v of values) if (v !== undefined) return true;
        return false;
    }
    ...
    function fromHSLAObject(obj) {
        var h = valuecheck(mod(obj.h, 360), { integer: true });
        var s = valuecheckHex(obj.s) / 255;
        var l = valuecheckHex(obj.l) / 255;
    ...
    function fromCMYKAObject(obj) {
        var [c, m, y, k] = [obj.c, obj.m, obj.y, obj.k].map(valuecheckHex);
        var v = 255 - k;
